...
class TestModelPipeline:
    ...
    def test_model_files_exist(self):
        ...
        assert os.path.exists(preprocessor_path), f"前処理ファイルが見つかりません: {preprocessor_path}"
    ...
    def test_processed_data_exists(self):
        ...
        assert os.path.exists(processed_data_path), f"処理済みデータが見つかりません: {processed_data_path}"
